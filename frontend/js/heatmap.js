...
var calendarHeatmap = {
   ...
   * Initialize
   */
  init: function(data, color, overview, container, handler) {
    ...
    // Set container
    calendarHeatmap.container = container || 'body';
  ...
  createElements: function() {
    ...
    if (calendarHeatmap.container == 'body') {
      document.body.appendChild(container);
    } else {
      document.getElementById(calendarHeatmap.container).appendChild(container);
    }
